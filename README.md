...
```shell
git clone git@github.com/WZ-RS/plonedemo.git
cd plonedemo
make install
```
...
- **backend**: API (Backend) Plone installation using pip (not buildout). Includes a policy package named plonedemo
...
**This was generated by [cookiecutter-plone-starter](https://github.com/collective/cookiecutter-plone-starter) on 2022-10-21 08:50:27**
